...
class DQN(nn.Module):
    def __init__(self, img_height, img_width):
        ...
        #Las posibles salidas para este ejemplo de gym son equivalentes a las acciones del emulador
        #por eso el output es  = 9
...
class CartPoleEnvManager():
    def __init__(self, device):
        #GPU o CPU?
        self.device = device
        # puede necesitar que se use .unwrapped
        self.env = retro.make(game='IceClimber-Nes')
        self.env.reset()
    ...
    def transform_screen_data(self, screen):
        ...
        #ejecutar el proceso de manera secuencial según se especifica
